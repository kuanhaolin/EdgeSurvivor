...
# 測試參數
START_USERS="${START_USERS:-1000}"         # 起始用戶數
...
RESULT_DIR="results/health-stress-$TIMESTAMP"
mkdir -p "$RESULT_DIR"

# 建立統計檔案
STATS_FILE="$RESULT_DIR/test-summary.txt"
echo "健康檢查 API 壓力測試報告" > "$STATS_FILE"
